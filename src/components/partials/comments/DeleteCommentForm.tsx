...
export default function DeleteCommentForm({ onSubmit, onCancel }: DeleteCommentFormProps) {
   return (
      <main className="text-sm space-y-2">
         <section className="flex flex-col py-5">
            <p>
               Estás a punto de eliminar tu comentario, ¿Seguro que deseas realizar esta acción?
            </p>
         </section>
