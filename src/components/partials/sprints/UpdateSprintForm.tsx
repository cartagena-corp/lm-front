...
interface FormProps {
   ...
   onCancel: () => void
   currentSprint: SprintProps
}

export default function UpdateSprintForm({ onSubmit, onCancel, currentSprint }: FormProps) {
   const [isStatusOpen, setIsStatusOpen] = useState(false)
   const { sprintStatuses } = useSprintStore()

   const [formData, setFormData] = useState<SprintProps>(currentSprint)
