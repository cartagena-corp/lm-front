   ...
   return (
      <div className="p-6">
         ...
         <div className="text-center mb-8">
            ...
            <hgroup className="flex flex-col">
               <h6 className="text-sm leading-relaxed" style={{ color: "var(--ds-text-secondary)" }}>
                  Estás a punto de eliminar el Sprint <b style={{ color: "var(--red-700)" }}>{sprintObject.title}</b> de forma permanente.
               </h6>
         ...
         <div className="flex justify-center gap-2 mt-4">
            ...
            <button className="w-full h-9 px-4 rounded-md text-sm font-medium transition-colors duration-150 bg-[var(--red-700)] hover:bg-[var(--red-800)] disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-2 focus-visible:outline-[var(--red-700)] focus-visible:outline-offset-2" type="button" style={{ color: "var(--ds-contrast-inverse)" }} onClick={() => handleSubmit()} disabled={isLoading}>
               Eliminar
            </button>
         </div>
      </div>
