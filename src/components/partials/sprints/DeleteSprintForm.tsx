   ...
   return (
      <main className="text-sm space-y-2">
         <section className="flex flex-col py-5">
            <p>
               Estás a punto de eliminar el sprint <b className="text-red-500">{sprintObject?.title}.</b> Las tareas de este sprint se asignarán al Backlog, ¿Seguro que deseas realizar esta acción?
            </p>
         </section>

         <section className="pb-3 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
            <button onClick={() => onSubmit(sprintObject)}
               type="button"
